...
from brasil.gov.tiles.tiles.em_destaque import EmDestaqueTile
from brasil.gov.tiles.tiles.em_destaque import IEmDestaqueTile
...
class EmDestaqueTileTestCase(TestTileMixin, unittest.TestCase):

    layer = INTEGRATION_TESTING

    def setUp(self):
        super(EmDestaqueTileTestCase, self).setUp()
        self.tile = EmDestaqueTile(self.cover, self.request)
        self.tile.__name__ = u'em_destaque'
        self.tile.id = u'test'

    @unittest.expectedFailure  # FIXME: raises BrokenImplementation
    def test_interface(self):
        self.interface = IEmDestaqueTile
        self.klass = EmDestaqueTile
        super(EmDestaqueTileTestCase, self).test_interface()
